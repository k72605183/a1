...
<head>
  ...
  <title>Celestial Chronometry & Haute Horology — Aperturedial</title>
  ...
  <link rel="canonical" href="https://aperturedial.com/">
...
<body>
  ...
  <div class="announcement-bar" style="background: #080B10; color: #FAF8F5; border-bottom: 1px solid rgba(212, 175, 55, 0.3);">
    <span>&#9672; HAUTE HORLOGERIE &bull; SIDEREAL CALIBRES &bull; SALON AT 181 MERCER STREET &bull; TEL: +1-888-777-5845 &bull; CONCIERGE@APERTUREDIAL.COM</span>
  </div>
  <!-- Mandatory Global Site Header (Exactly 1 per page) -->
  <header class="site-header">
    <div class="header-container">
      <a href="/" class="brand-logo" aria-label="Aperturedial Home">
        <span class="logo-mark">◈</span>
        <span class="logo-text">Aperturedial</span>
      </a>
  ...
  <div class="mobile-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
      <div class="drawer-brand">Aperturedial</div>
    ...
    <div class="drawer-footer">
      ...
      <p class="drawer-contact-info">Email: concierge@aperturedial.com</p>
    </div>
  </div>
      ...
      <div style="display: grid; grid-template-columns: 1.15fr 1fr; gap: 4rem; align-items: center;">
        ...
        <div style="position: relative;">
          <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 2px solid rgba(212, 175, 55, 0.6);">
            <img src="/assets/images/watch_1.jpg" alt="Aperturedial flagship chronometer" style="width: 100%; height: auto;">
          </div>
  ...
  <section class="section">
    <div class="container">
      <div class="section-header text-center">
        ...
        <h2>Four Architectural Pillars of Aperturedial</h2>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Aperturedial Bespoke Standard</th>
  ...
  <section class="section section-light">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p class="text-muted" style="max-width: 650px; margin: 0.8rem auto 0;">
          Reflections from international collectors, horologists, and long-standing patrons of Aperturedial.
        </p>
      </div>
      <div class="grid-3">
    ...
    <div class="container">
      <div class="contact-grid">
        <div class="contact-info-card">
          ...
          <div class="contact-detail-row">
            <span class="contact-icon">◈</span>
            <div><strong>Concierge Dispatch:</strong><br>concierge@aperturedial.com</div>
          </div>
          <div class="contact-detail-row">
            <span class="contact-icon">◈</span>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <div class="footer-brand">◈ Aperturedial</div>
          <p class="footer-desc">
          ...
          <div class="footer-contact-item"><strong>Concierge:</strong> concierge@aperturedial.com</div>
        </div>
        <div class="footer-col">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Aperturedial Atelier. All Rights Reserved. Handcrafted at 181 Mercer Street, New York, NY 10012, United States.</p>
